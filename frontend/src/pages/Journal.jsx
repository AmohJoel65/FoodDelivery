...
const Journal = () => {
  ...
  return (
    <main className="min-h-screen bg-[#fdfbf7] text-[#1a1a1a] pb-24" aria-label="Joel Culinary Journal Page">
      {/* 1. Magazine Banner Header */}
      <section className="relative bg-[#1a1a1a] text-[#fdfbf7] py-24 md:py-32 px-6 overflow-hidden">
        <div className="absolute inset-0 opacity-15 pointer-events-none">
          <div className="absolute top-1/2 left-1/3 w-[800px] h-[300px] rounded-full bg-[#d4af37] blur-3xl transform rotate-12"></div>
        </div>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
          <div className="max-w-2xl text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-serif tracking-tight mb-4 text-[#fdfbf7]">
              Culinary Journal
            </h1>
            <p className="text-[#fdfbf7]/80 text-sm md:text-base font-light leading-relaxed">
          ...
          <div className="w-full md:w-80 shrink-0">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-[#e4e1db]/30 bg-white/10 text-white focus:outline-none focus:bg-white focus:text-[#1a1a1a] focus:ring-4 focus:ring-[#d4af37]/20 placeholder-gray-400 transition-all text-sm"
              />
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl border border-[#e4e1db]/60 shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 group">
            <div className="grid grid-cols-1 lg:grid-cols-12">
              <div className="lg:col-span-7 relative h-64 sm:h-96 lg:h-full overflow-hidden min-h-[350px]">
                ...
                />
                <span className="absolute top-4 left-4 bg-[#d4af37] text-[#1a1a1a] text-[10px] tracking-widest uppercase font-bold px-3 py-1 rounded-full flex items-center gap-1 shadow-lg">
              ...
              <div className="lg:col-span-5 p-8 md:p-12 flex flex-col justify-between space-y-6">
                ...
                <div className="border-t border-[#e4e1db]/60 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-[#1a1a1a] text-[#d4af37] flex items-center justify-center font-serif text-sm font-bold border border-[#d4af37]/30">
                      JS
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-4 text-xs font-semibold">
                    ...
                    <button 
                      ...
                      className="text-[#d4af37] uppercase tracking-widest flex items-center gap-1.5 hover:text-[#1a1a1a] transition-colors"
      ...
      <section className="max-w-7xl mx-auto px-6 mt-16" aria-label="Journal Articles Feed">
              ...
              >
                <div>
                  <div className="relative h-56 overflow-hidden">
                    ...
                    />
                    <span className="absolute top-3 left-3 bg-[#1a1a1a] text-white text-[9px] tracking-wider uppercase font-semibold px-2.5 py-1 rounded-md">
                      {article.category}
                    </span>
                  </div>
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    <h3 className="text-lg font-serif font-bold group-hover:text-[#d4af37] transition-colors line-clamp-2">
                      {article.title}
                    </h3>
                ...
                <div className="p-6 border-t border-gray-100 flex justify-between items-center">
                  <span className="text-[10px] text-gray-400 flex items-center gap-1.5">
                    <User className="w-3.5 h-3.5 text-[#d4af37]" /> By {article.author}
                  </span>
                  <button 
                    onClick={() => handleReadArticle(article.id)}
                    className="text-xs font-semibold text-[#1a1a1a] uppercase tracking-wider flex items-center gap-1 hover:text-[#d4af37] transition-colors"
        ...
        {filteredArticles.length === 0 && (
          <div className="text-center py-20 bg-white rounded-3xl border border-[#e4e1db]/40 p-8 mt-10">
            <Newspaper className="w-12 h-12 text-[#d4af37] mx-auto mb-4 opacity-50" />
            ...
            <button 
              ...
              className="mt-6 px-6 py-2.5 bg-[#1a1a1a] text-white text-xs font-semibold tracking-wider uppercase rounded-xl hover:bg-[#1a1a1a]/95 active:scale-95 transition-all"
            >
